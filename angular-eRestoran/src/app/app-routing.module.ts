...
const routes: Routes = [
  ...
  {path: 'actors1', component: IndexActorsComponent},
  {path: 'rezervacije', component: RezervacijeComponent},
  {path: 'narudzbe', component: NarudzbeComponent},
  {path: 'detalji', component: DetaljiNarudzbeComponent},
  ...
  {path: 'korpa', component: KorpaIndexComponent},
  {path: 'narudzba', component: NarudzbaDetaljiComponent},
